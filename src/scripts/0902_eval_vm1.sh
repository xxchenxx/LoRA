python src/gpt2_decode.py          --vocab ./vocab          --sample_file ./trained_models/GPT2_M/dart_rank4_bilateral_step1000/predict.100000.b10p08.jsonl          --input_file ./data/dart/test_formatted.jsonl          --ref_type dart          --ref_num 6          --output_ref_file eval/GenerationEval/data/references_dart          --output_pred_file eval/GenerationEval/data/hypothesis_dart          --tokenize --lower
