...
class Attention(nn.Module):
    def __init__(self, nx, n_ctx, config, scale=False):
        ...
        self.register_buffer("U_Q", torch.zeros(1024, 2))
        self.register_buffer("U_V", torch.zeros(1024, 2))

        self.register_buffer("V_Q", torch.zeros(2, 1024))
        self.register_buffer("V_V", torch.zeros(2, 1024))
