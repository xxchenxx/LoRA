CUDA_VISIBLE_DEVICES=0 NCCL_P2P_DISABLE=1 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8281 src/gpt2_ft.py \
    ...
    --random_seed 1 \
    --save_interval 50000 > 0903_bilateral_rank1_seed1.out &
...
CUDA_VISIBLE_DEVICES=1 NCCL_P2P_DISABLE=1 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8282 src/gpt2_ft.py \
    ...
    --random_seed 1 \
    --save_interval 50000 > 0903_bilateral_rank2_seed1.out &
...
CUDA_VISIBLE_DEVICES=2 NCCL_P2P_DISABLE=1 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8283 src/gpt2_ft.py \
    ...
    --random_seed 1 \
    --save_interval 50000 > 0903_bilateral_rank3_seed1.out &
...
CUDA_VISIBLE_DEVICES=3 NCCL_P2P_DISABLE=1 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8284 src/gpt2_ft.py \
    ...
    --random_seed 1 \
    --save_interval 50000 > 0903_bilateral_rank4_seed1.out &
