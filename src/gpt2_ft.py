...
if __name__ == '__main__':
  ...
  for name, module in lm_net.named_modules():
    ...
    if isinstance(module, Attention):
      ...
      U_Q = torch.randn((module.q_proj_adapter2.weight.data.shape[0], 1))
      V_Q = torch.randn((1, module.q_proj_adapter1.weight.data.shape[1]))
      S_Q = module.S_Q.data

      U_Q = torch.randn((module.v_proj_adapter2.weight.data.shape[0], 1))
      V_Q = torch.randn((1, module.v_proj_adapter1.weight.data.shape[1]))
      S_V = module.S_V.data
