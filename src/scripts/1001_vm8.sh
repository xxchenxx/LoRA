CUDA_VISIBLE_DEVICES=4,5,6,7 NCCL_P2P_DISABLE=1 python -m torch.distributed.launch --nproc_per_node=4 --master_port=8281 src/gpt2_ft.py \
    ...
    --random_seed 110 \
    --save_interval 10000 > 0928_bilateral_smooth_rank32.out
...
CUDA_VISIBLE_DEVICES=0,1,2,3 NCCL_P2P_DISABLE=1 python -m torch.distributed.launch --nproc_per_node=4 --master_port=8281 src/gpt2_ft.py \
    ...
    --random_seed 110 \
    --save_interval 10000 > 0928_bilateral_smooth_rank16.out
...
CUDA_VISIBLE_DEVICES=4,5,6,7 NCCL_P2P_DISABLE=1 python -m torch.distributed.launch --nproc_per_node=4 --master_port=8281 src/gpt2_ft.py \
    ...
    --random_seed 110 \
    --save_interval 10000 > 0928_bilateral_smooth_rank8.out
...
CUDA_VISIBLE_DEVICES=0,1,2,3 NCCL_P2P_DISABLE=1 python -m torch.distributed.launch --nproc_per_node=4 --master_port=8281 src/gpt2_ft.py \
    ...
    --random_seed 110 \
    --save_interval 10000 > 0928_bilateral_smooth_rank6.out 
