CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8761 src/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models/GPT2_M_bilateral_smooth_rank32_seed110/model.26289.pt \
    --platform local \
    --lora_dim 32 \
    --lora_alpha 32 \
    --beam 10 \
    ...
    --eos_token_id 628 \
    --work_dir ./trained_models/GPT2_M_bilateral_smooth_rank32_seed110 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8762 src/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models/GPT2_M_bilateral_smooth_rank16_seed110/model.26289.pt \
    --platform local \
    --lora_dim 16 \
    --lora_alpha 32 \
    --beam 10 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8763 src/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models/GPT2_M_bilateral_smooth_rank8_seed110/model.26289.pt \
    --platform local \
    --lora_dim 8 \
    --lora_alpha 32 \
    --beam 10 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8764 src/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models/GPT2_M_bilateral_smooth_rank6_seed110/model.26289.pt \
    --platform local \
    --lora_dim 6 \
    --lora_alpha 32 \
    --beam 10 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8765 src/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models/GPT2_M_bilateral_smooth_rank4_seed110/model.26289.pt \
    --platform local \
    --lora_dim 4 \
    --lora_alpha 32 \
    --beam 10 \
    ...
    --repetition_penalty 1.0 \
    --eos_token_id 628 \
    --work_dir ./trained_models/GPT2_M_bilateral_smooth_rank4_seed110 \
    --output_file predict.26289.b10p08.jsonl &
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python -m torch.distributed.launch --nproc_per_node=1 --master_port=8766 src/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models/GPT2_M_rank4_seed110/model.26289.pt \
    --platform local \
    --lora_dim 4 \
    --lora_alpha 32 \
    --beam 10 \
    ...
    --repetition_penalty 1.0 \
    --eos_token_id 628 \
    --work_dir ./trained_models/GPT2_M_rank4_seed110 \
    --output_file predict.26289.b10p08.jsonl
